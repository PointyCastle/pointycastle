...
class RIPEMD160Digest extends MD4FamilyDigest implements Digest {
  ...
  int doFinal( Uint8List out, int outOff ) {
    ...
    pack32(_H[0], out, (outOff     ), Endianness.LITTLE_ENDIAN);
    pack32(_H[1], out, (outOff +  4), Endianness.LITTLE_ENDIAN);
    pack32(_H[2], out, (outOff +  8), Endianness.LITTLE_ENDIAN);
    pack32(_H[3], out, (outOff + 12), Endianness.LITTLE_ENDIAN);
    pack32(_H[4], out, (outOff + 16), Endianness.LITTLE_ENDIAN);
  ...
  void processBlock() {
    ...
    dd = clip32(dd + c + _H[1]);
    _H[1] = clip32(_H[2] + d + ee);
    _H[2] = clip32(_H[3] + e + aa);
    _H[3] = clip32(_H[4] + a + bb);
    _H[4] = clip32(_H[0] + b + cc);
    _H[0] = dd;
