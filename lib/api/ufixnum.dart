...
class Uint8 extends UintX {
  ...
  static int clip(value) => (value.toInt()&0xFF);

  Uint8(value) : super(value.toInt());

  int get bitLength => 8;
  int get byteLength => 1;

  int _clip(value) => clip(value);
  Uint8 _coerce(value) => new Uint8(value);
...
class Uint16 extends UintX {
  ...
  static int clip(value) => (value.toInt()&0xFFFF);

  Uint16(value) : super(value.toInt());
  ...
  int _clip(value) => clip(value);
  Uint16 _coerce(value) => new Uint16(value);
...
class Uint32 extends UintX {
  ...
  static int clip(value) => (value.toInt()&0xFFFFFFFF);

  Uint32(value) : super(value.toInt());
  ...
  int _clip(value) => clip(value);
  Uint32 _coerce(value) => new Uint32(value);
...
class Uint64 extends UintX {
  ...
  static int clip(value) => (value.toInt()&0xFFFFFFFFFFFFFFFF);

  Uint64(value) : super(value.toInt());
  ...
  int _clip(value) => clip(value);
  Uint64 _coerce(value) => new Uint64(value);
